...
date: 2022-07-17T19:17:16+09:00
author: [hum_op]
tags: [infra]
---
...
![vault ui](/images/use-credentials-from-hashicorp-vault-in-ansible/vault-ui.png)
...
![](/images/use-credentials-from-hashicorp-vault-in-ansible/vault-secret-list.png)

1. テーブルの右上にある`Enable new secret`をクリックし作成ページに遷移します。

2. `KV`を選択し`Next`をクリックします。

![](/images/use-credentials-from-hashicorp-vault-in-ansible/vault-enable-kv-secret.png)

3. Path に`kv-test`を指定し`Enable Engine`をクリックします。
   (デフォルトでは`kv`が指定されてます)

![](/images/use-credentials-from-hashicorp-vault-in-ansible/vault-enable-kv-secret-2.png)

4. 作成された secret engine のページに遷移されます。

![](/images/use-credentials-from-hashicorp-vault-in-ansible/vault-enable-kv-secret-3.png)
...
![](/images/use-credentials-from-hashicorp-vault-in-ansible/vault-create-secret-1.png)

3. 作成されたシークレットのページに遷移されます。

![](/images/use-credentials-from-hashicorp-vault-in-ansible/vault-create-secret-2.png)
